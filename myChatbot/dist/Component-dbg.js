	...
	return UIComponent.extend("sap.suite.ui.commons.demo.tutorial.Component", {
		...
		init: function() {
			...
			this.setModel(new JSONModel({
				...
				messages: [{
					role: "assistant",
					content: "Szia, en Noah vagyok! Irj szabad szovegesen, es kivalasztom a megfelelo megoldast. Hasznald a Prompt Javitot a pontosabb kerdesekhez, vagy kapcsold be a Noah Agent modot a tobblepeses tervekhez.",
					feedback: "",
					infoOpen: false
				}],
				attachments: [],
